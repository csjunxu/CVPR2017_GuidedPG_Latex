...
\mathbf{\Sigma}_{k}=\mathbf{U}_{k}\mathbf{S}_{k}\mathbf{U}_{k}^{T}.
\end{equation}
...
Assume we have assigned all internal noisy PGs to their corresponding most suitable Gaussians or subspaces in $\{\mathcal{N}(\mathbf{0},\mathbf{\Sigma}_{k})\}_{k=1}^{K}$. For noisy PGs $\mathbf{Y}=[\mathbf{y}_{1},...,\mathbf{y}_{N_{k}}]$ in the $k$-th subspace, we consider to utilize the external orthogonal dictionary to guide the learning of an orthogonal dictionary $\mathbf{D}_{k}:=[\mathbf{D}_{k,e}\ \mathbf{D}_{k,i}]\in \mathbb{R}^{3p^2\times 3p^2}$. This dictionary has two parts: the external part $\mathbf{D}_{k,e}=\mathbf{U}_{k}(:,1:3p^2-r)\in\mathbb{R}^{3p^2\times (3p^2-r)}$ is obtained from the external prior by Equ. (\ref{equ3}), and the internal part $\mathbf{D}_{k,i}$ is consisted of adaptive dictionary atoms learned from the internal noisy PGs. The learning and denoising are simultaneously performed under the proposed reweighted sparse coding framework as f(for notation simplicity, we ignore the subspace index $k$):
\vspace{-2mm}
...
\text{s.t.}
\quad
\mathbf{D}=[\mathbf{D}_{e}\ \mathbf{D}_{i}],\ \mathbf{D}_{i}^{T}\mathbf{D}_{i} = \mathbf{I}_{r},\ \mathbf{D}_{e}^{T}\mathbf{D}_{i} = \mathbf{0},
\end{split}
\end{equation}
...
\|\mathbf{y}_{m}-\mathbf{D}_{(t)}\bm{\alpha}_{n}\|_{2}^{2}+\sum_{j=1}^{3p^{2}}\lambda_{j}|\bm{\alpha}_{n,j}|
\\
&
\text{s.t.}
\quad
\mathbf{D}_{(t)}=[\mathbf{D}_{e}\ \mathbf{D}_{i}],\ \mathbf{D}_{i}^{T}\mathbf{D}_{i} = \mathbf{I}_{r},\ \mathbf{D}_{e}^{T}\mathbf{D}_{i} = \mathbf{0},
\end{split}
\end{equation}
...
\hat{\bm{\alpha}}_{n}= \text{sgn}(\mathbf{D}_{(t)}^{T}\mathbf{y}_{n})\odot \text{max}(|\mathbf{D}_{(t)}^{T}\mathbf{y}_{n}|-\mathbf{\Lambda},\mathbf{0}),
\end{equation}
...
&
=
[\mathbf{D}_{e}\ \mathbf{D}_{i}],\ \mathbf{D}_{i}^{T}\mathbf{D}_{i} = \mathbf{I}_{r},\ \mathbf{D}_{e}^{T}\mathbf{D}_{i} = \mathbf{0},
\end{split}
\end{equation}
