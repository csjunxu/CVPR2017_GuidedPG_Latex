...
%%%%%%%%% TITLE
\title{External Patch Group Prior Guided Adaptive Orthogonal Dictionary Learning for Real Image Denoising}
...
\subsection{External Prior Guided Adaptive Orthogonal Dictionary Learning}
...
\begin{split}
&\min_{\mathbf{D}\in \mathbb{R}^{3p^2\times r}}\|\mathbf{Y}-[\mathbf{D}_{e};\mathbf{D}_{i}]\mathbf{A}\|_{F}^{2}+\lambda\|\mathbf{A}\|_{1}
\\
&
\text{s.t.}
\quad
