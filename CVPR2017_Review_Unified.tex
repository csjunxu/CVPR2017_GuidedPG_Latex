...
The real noisy images in the first dataset \cite{ncwebsite} do not have ``ground truth" images. 
We compare the proposed method with other state-of-the-art image denoising methods such as BM3D \cite{bm3d}, WNNM \cite{wnnm}, MLP \cite{mlp}, CSF \cite{csf}, TRD \cite{chen2015learning}, Noise Clinic (NC) \cite{noiseclinic}, Cross-Channel (CC) \cite{crosschannel2016}. 
...
while those in the second dataset \cite{crosschannel2016} have corresponding ``ground truth" images.
