...
\centering
\includegraphics[width=0.85\linewidth]{Flowchart2.png}
\vspace{-2mm}
...
\begin{minipage}[t]{0.195\textwidth}
\centering  
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{images/resize_br_Noisy_CC_Noisy_Nikon_D800_ISO_3200_A1_111.png}}
{\footnotesize (a) Noisy \cite{crosschannel2016}: 34.02dB  }
\end{minipage}
\begin{minipage}[t]{0.195\textwidth} 
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{images/resize_br_Offline_CC_Noisy_Nikon_D800_ISO_3200_A1_111.png}}
{\footnotesize (b) External: 35.58dB }
\end{minipage}
\begin{minipage}[t]{0.195\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{images/resize_br_Online_CC_Noisy_Nikon_D800_ISO_3200_A1_111.png}}
{\footnotesize (c) Internal: 36.74dB }
\end{minipage}
\begin{minipage}[t]{0.195\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{images/resize_br_Guided_CC_Noisy_Nikon_D800_ISO_3200_A1_111.png}}
{\footnotesize (d) Guided Internal: \textbf{37.87}dB }
\end{minipage}
\begin{minipage}[t]{0.195\textwidth}
\centering
\raisebox{-0.15cm}{\includegraphics[width=1\textwidth]{images/resize_br_Mean_CC_Noisy_Nikon_D800_ISO_3200_A1_111.png}}
{\footnotesize (e) Mean Image \cite{crosschannel2016}}
\end{minipage}
}\vspace{-1mm}
