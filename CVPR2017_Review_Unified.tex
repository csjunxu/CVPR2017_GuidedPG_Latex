...
{\footnotesize (g) NC \cite{noiseclinic,ncwebsite}: 35.33dB  }
\end{minipage}
\begin{minipage}[t]{0.195\textwidth}
\centering
...
\\
\hline
Methods& \textbf{TNRD}& \textbf{NC} & \textbf{NI} &\textbf{Ours} 
\\
\hline
PSNR &  {\color{blue}{37.75}} & 37.57  & 36.53 & {\color{red}{ 38.75}}
\\
\hline
\end{tabular}
...
{\footnotesize (f) NC \cite{noiseclinic,ncwebsite}: 38.76dB }
\end{minipage}
\begin{minipage}[t]{0.195\textwidth}
\centering
