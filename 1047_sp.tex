...
For notation simplicity, we ignore the indices $n,m,t$ in the problem (6) in the main paper. And it turns into the following weighted sparse coding problem:
\vspace{-4mm}
...
\end{equation}
where $\bm{\lambda} = \frac{1}{2}[\lambda_{1},\lambda_{2},...,\lambda_{3p^2}]$ is the vector of regularization parameter and $\odot$ means element-wise multiplication.
