...
In this section, we provide more visual comparisons of the proposed method with the state-of-the-art denoising methods on the 15 cropped real noisy images used in \cite{crosschannel2016}. As can be seen from Fiures \ref{fig5}-\ref{fig8}, our proposed method achieves better performance than the the competing methods. This validates the effectiveness of our proposed external prior guided internal prior learning framework for real noisy image denoising.
...
{\footnotesize (g) NC \cite{noiseclinic,ncwebsite}: 35.69dB  }
\end{minipage}
\begin{minipage}[t]{0.195\textwidth}
\centering
